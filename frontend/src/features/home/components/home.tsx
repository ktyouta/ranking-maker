        ...
        <div className="w-full flex-1 px-3 py-5 sm:py-12 sm:px-6 lg:px-20">
            {rankingList.length === 0 && (
                <div className="flex flex-col items-center gap-3 py-16 text-center">
                    <IoTrophyOutline className="size-16 text-accent-surface" />
                    ...
                    {rankingList.map((ranking) => (
                        ...
                        >
                            <div className="border-b border-line bg-gradient-to-r from-accent/10 to-transparent px-5 py-2.5">
                                <span className="flex size-9 items-center justify-center rounded-full bg-accent-surface text-white shadow-sm">
